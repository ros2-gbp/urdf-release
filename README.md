## urdf (rolling) - 2.14.1-1

The packages in the `urdf` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling urdf` on `Wed, 16 Sep 2026 08:08:24 -0000`
...
The packages in the `urdf` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy urdf` on `Wed, 03 Jun 2026 05:21:20 -0000`
...
The packages in the `urdf` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy urdf` on `Wed, 03 Jun 2026 05:09:17 -0000`
...
## urdf (rolling) - 2.14.0-1

The packages in the `urdf` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling urdf` on `Tue, 05 May 2026 16:50:04 -0000`
...
## urdf (rolling) - 2.13.2-1

The packages in the `urdf` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release urdf --rosdistro rolling --track rolling` on `Tue, 14 Apr 2026 03:58:44 -0000`
...
## urdf (kilted) - 2.12.3-1

The packages in the `urdf` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted urdf` on `Mon, 19 Jan 2026 16:21:26 -0000`
...
## urdf (rolling) - 2.13.1-1

The packages in the `urdf` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling urdf` on `Mon, 19 Jan 2026 16:12:12 -0000`
...
- upstream repository: https://github.com/ros2/urdf.git
- release repository: https://github.com/ros2-gbp/urdf-release.git
- rosdistro version: `2.13.0-2`
- old version: `2.13.0-2`
...
## urdf (rolling) - 2.13.0-1

The packages in the `urdf` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release urdf -r rolling` on `Sat, 26 Apr 2025 01:45:27 -0000`
...
## urdf (rolling) - 2.12.2-1

The packages in the `urdf` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling urdf` on `Fri, 20 Dec 2024 15:58:31 -0000`
...
## urdf (rolling) - 2.12.1-1

The packages in the `urdf` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling urdf` on `Fri, 13 Dec 2024 16:26:41 -0000`
